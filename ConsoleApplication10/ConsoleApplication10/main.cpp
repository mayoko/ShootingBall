...
// after.push_back(cv::Point(0,534));
// after.push_back(cv::Point(950,534));
// after.push_back(cv::Point(950,0));
// */
////
//
// //H_pcのとき
// 
// after.push_back(cv::Point(100*1366/1280,100*768/800));
// after.push_back(cv::Point(100*1366/1280,700*768/800));
// after.push_back(cv::Point(1180*1366/1280,700*768/800));
// after.push_back(cv::Point(1180*1366/1280,100*768/800));
// 
// //
// 
...
// cout <<H << std::endl;
// 
// ofstream ofs( "H_pc.txt" );    //H_wc,H_pcで書き換え必要
